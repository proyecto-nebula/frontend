...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, RegistrationAccountUi, RegistrationVerifyEmailUi, RegistrationProfileUi, RegistrationPlanUi, RegistrationPaymentUi, LogoComponent],
...
export class JoinPage {
  ...
  get plan(): FormGroup    { return this.form.get('plan') as FormGroup; }
  get payment(): FormGroup { return this.form.get('payment') as FormGroup; }
  ...
  get currentGroup(): FormGroup {
    switch (this.phase) {
      ...
      case 1: return this.account; // verify phase — validation skipped in next()
      case 2: return this.profile;
      case 3: return this.plan;
      case 4: return this.payment;
  ...
  get nextLabel(): string {
    ...
    if (this.phase === 4) return 'Finalizar';
    return 'Siguiente';
  }
